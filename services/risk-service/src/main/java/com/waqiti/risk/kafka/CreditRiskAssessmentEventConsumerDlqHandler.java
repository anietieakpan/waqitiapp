...
/**
 * DLQ Handler for CreditRiskAssessmentEventConsumer
 *
...
@Service
@Slf4j
public class CreditRiskAssessmentEventConsumerDlqHandler extends BaseDlqConsumer<Object> {

    public CreditRiskAssessmentEventConsumerDlqHandler(MeterRegistry meterRegistry) {
        super(meterRegistry);
    }

    @PostConstruct
    public void init() {
        initializeMetrics("CreditRiskAssessmentEventConsumer");
    }

    @KafkaListener(
        topics = "${kafka.topics.CreditRiskAssessmentEventConsumer.dlq:CreditRiskAssessmentEventConsumer.dlq}",
    ...
    protected String getServiceName() {
        return "CreditRiskAssessmentEventConsumer";
    }
}

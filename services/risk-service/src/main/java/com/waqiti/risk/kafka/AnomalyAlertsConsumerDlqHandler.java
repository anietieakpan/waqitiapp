...
/**
 * DLQ Handler for AnomalyAlertsConsumer
 *
...
@Service
@Slf4j
public class AnomalyAlertsConsumerDlqHandler extends BaseDlqConsumer<Object> {

    public AnomalyAlertsConsumerDlqHandler(MeterRegistry meterRegistry) {
        super(meterRegistry);
    }

    @PostConstruct
    public void init() {
        initializeMetrics("AnomalyAlertsConsumer");
    }

    @KafkaListener(
        topics = "${kafka.topics.AnomalyAlertsConsumer.dlq:AnomalyAlertsConsumer.dlq}",

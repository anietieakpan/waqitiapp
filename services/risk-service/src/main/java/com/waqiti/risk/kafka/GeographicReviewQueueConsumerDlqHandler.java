...
/**
 * DLQ Handler for GeographicReviewQueueConsumer
 *
...
@Service
@Slf4j
public class GeographicReviewQueueConsumerDlqHandler extends BaseDlqConsumer<Object> {

    public GeographicReviewQueueConsumerDlqHandler(MeterRegistry meterRegistry) {
        super(meterRegistry);
    }

    @PostConstruct
    public void init() {
        initializeMetrics("GeographicReviewQueueConsumer");
    }

    @KafkaListener(
        topics = "${kafka.topics.GeographicReviewQueueConsumer.dlq:GeographicReviewQueueConsumer.dlq}",
    ...
    protected String getServiceName() {
        return "GeographicReviewQueueConsumer";
    }
}

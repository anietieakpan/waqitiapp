...
/**
 * DLQ Handler for InfrastructureAlertsConsumer
 *
...
@Service
@Slf4j
public class InfrastructureAlertsConsumerDlqHandler extends BaseDlqConsumer<Object> {

    public InfrastructureAlertsConsumerDlqHandler(MeterRegistry meterRegistry) {
        super(meterRegistry);
    }

    @PostConstruct
    public void init() {
        initializeMetrics("InfrastructureAlertsConsumer");
    }

    @KafkaListener(
        topics = "${kafka.topics.InfrastructureAlertsConsumer.dlq:InfrastructureAlertsConsumer.dlq}",
    ...
    protected String getServiceName() {
        return "InfrastructureAlertsConsumer";
    }
}

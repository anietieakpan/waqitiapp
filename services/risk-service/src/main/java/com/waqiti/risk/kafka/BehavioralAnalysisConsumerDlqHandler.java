...
/**
 * DLQ Handler for BehavioralAnalysisConsumer
 *
...
@Service
@Slf4j
public class BehavioralAnalysisConsumerDlqHandler extends BaseDlqConsumer<Object> {

    public BehavioralAnalysisConsumerDlqHandler(MeterRegistry meterRegistry) {
        super(meterRegistry);
    }

    @PostConstruct
    public void init() {
        initializeMetrics("BehavioralAnalysisConsumer");
    }

    @KafkaListener(
        topics = "${kafka.topics.BehavioralAnalysisConsumer.dlq:BehavioralAnalysisConsumer.dlq}",
    ...
    protected String getServiceName() {
        return "BehavioralAnalysisConsumer";
    }
}

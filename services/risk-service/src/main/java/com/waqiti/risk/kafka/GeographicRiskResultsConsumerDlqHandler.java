...
/**
 * DLQ Handler for GeographicRiskResultsConsumer
 *
...
@Service
@Slf4j
public class GeographicRiskResultsConsumerDlqHandler extends BaseDlqConsumer<Object> {

    public GeographicRiskResultsConsumerDlqHandler(MeterRegistry meterRegistry) {
        super(meterRegistry);
    }

    @PostConstruct
    public void init() {
        initializeMetrics("GeographicRiskResultsConsumer");
    }

    @KafkaListener(
        topics = "${kafka.topics.GeographicRiskResultsConsumer.dlq:GeographicRiskResultsConsumer.dlq}",
    ...
    protected String getServiceName() {
        return "GeographicRiskResultsConsumer";
    }
}

...
/**
 * DLQ Handler for RiskAppetiteMonitoringEventsConsumer
 *
...
@Service
@Slf4j
public class RiskAppetiteMonitoringEventsConsumerDlqHandler extends BaseDlqConsumer<Object> {

    public RiskAppetiteMonitoringEventsConsumerDlqHandler(MeterRegistry meterRegistry) {
        super(meterRegistry);
    }

    @PostConstruct
    public void init() {
        initializeMetrics("RiskAppetiteMonitoringEventsConsumer");
    }

    @KafkaListener(
        topics = "${kafka.topics.RiskAppetiteMonitoringEventsConsumer.dlq:RiskAppetiteMonitoringEventsConsumer.dlq}",
    ...
    protected String getServiceName() {
        return "RiskAppetiteMonitoringEventsConsumer";
    }
}

...
/**
 * DLQ Handler for OperationalRiskEventConsumer
 *
...
@Service
@Slf4j
public class OperationalRiskEventConsumerDlqHandler extends BaseDlqConsumer<Object> {

    public OperationalRiskEventConsumerDlqHandler(MeterRegistry meterRegistry) {
        super(meterRegistry);
    }

    @PostConstruct
    public void init() {
        initializeMetrics("OperationalRiskEventConsumer");
    }

    @KafkaListener(
        topics = "${kafka.topics.OperationalRiskEventConsumer.dlq:OperationalRiskEventConsumer.dlq}",
    ...
    protected String getServiceName() {
        return "OperationalRiskEventConsumer";
    }
}

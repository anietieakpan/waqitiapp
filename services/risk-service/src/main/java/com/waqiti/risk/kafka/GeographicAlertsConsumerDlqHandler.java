...
/**
 * DLQ Handler for GeographicAlertsConsumer
 *
...
@Service
@Slf4j
public class GeographicAlertsConsumerDlqHandler extends BaseDlqConsumer<Object> {

    public GeographicAlertsConsumerDlqHandler(MeterRegistry meterRegistry) {
        super(meterRegistry);
    }

    @PostConstruct
    public void init() {
        initializeMetrics("GeographicAlertsConsumer");
    }

    @KafkaListener(
        topics = "${kafka.topics.GeographicAlertsConsumer.dlq:GeographicAlertsConsumer.dlq}",
    ...
    protected String getServiceName() {
        return "GeographicAlertsConsumer";
    }
}

...
/**
 * DLQ Handler for InfrastructureStatusEventsConsumer
 *
...
@Service
@Slf4j
public class InfrastructureStatusEventsConsumerDlqHandler extends BaseDlqConsumer<Object> {

    public InfrastructureStatusEventsConsumerDlqHandler(MeterRegistry meterRegistry) {
        super(meterRegistry);
    }

    @PostConstruct
    public void init() {
        initializeMetrics("InfrastructureStatusEventsConsumer");
    }

    @KafkaListener(
        topics = "${kafka.topics.InfrastructureStatusEventsConsumer.dlq:InfrastructureStatusEventsConsumer.dlq}",
    ...
    protected String getServiceName() {
        return "InfrastructureStatusEventsConsumer";
    }
}

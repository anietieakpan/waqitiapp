...
/**
 * DLQ Handler for TransactionClusteringConsumer
 *
...
@Service
@Slf4j
public class TransactionClusteringConsumerDlqHandler extends BaseDlqConsumer<Object> {

    public TransactionClusteringConsumerDlqHandler(MeterRegistry meterRegistry) {
        super(meterRegistry);
    }

    @PostConstruct
    public void init() {
        initializeMetrics("TransactionClusteringConsumer");
    }

    @KafkaListener(
        topics = "${kafka.topics.TransactionClusteringConsumer.dlq:TransactionClusteringConsumer.dlq}",
    ...
    protected String getServiceName() {
        return "TransactionClusteringConsumer";
    }
}

...
/**
 * DLQ Handler for ModelRiskValidationEventsConsumer
 *
...
@Service
@Slf4j
public class ModelRiskValidationEventsConsumerDlqHandler extends BaseDlqConsumer<Object> {

    public ModelRiskValidationEventsConsumerDlqHandler(MeterRegistry meterRegistry) {
        super(meterRegistry);
    }

    @PostConstruct
    public void init() {
        initializeMetrics("ModelRiskValidationEventsConsumer");
    }

    @KafkaListener(
        topics = "${kafka.topics.ModelRiskValidationEventsConsumer.dlq:ModelRiskValidationEventsConsumer.dlq}",
    ...
    protected String getServiceName() {
        return "ModelRiskValidationEventsConsumer";
    }
}

...
/**
 * DLQ Handler for OperationalRiskEventsConsumer
 *
...
@Service
@Slf4j
public class OperationalRiskEventsConsumerDlqHandler extends BaseDlqConsumer<Object> {

    public OperationalRiskEventsConsumerDlqHandler(MeterRegistry meterRegistry) {
        super(meterRegistry);
    }

    @PostConstruct
    public void init() {
        initializeMetrics("OperationalRiskEventsConsumer");
    }

    @KafkaListener(
        topics = "${kafka.topics.OperationalRiskEventsConsumer.dlq:OperationalRiskEventsConsumer.dlq}",
    ...
    protected String getServiceName() {
        return "OperationalRiskEventsConsumer";
    }
}

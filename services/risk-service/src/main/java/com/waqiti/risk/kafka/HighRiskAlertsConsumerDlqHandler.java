...
/**
 * DLQ Handler for HighRiskAlertsConsumer
 *
...
@Service
@Slf4j
public class HighRiskAlertsConsumerDlqHandler extends BaseDlqConsumer<Object> {

    public HighRiskAlertsConsumerDlqHandler(MeterRegistry meterRegistry) {
        super(meterRegistry);
    }

    @PostConstruct
    public void init() {
        initializeMetrics("HighRiskAlertsConsumer");
    }

    @KafkaListener(
        topics = "${kafka.topics.HighRiskAlertsConsumer.dlq:HighRiskAlertsConsumer.dlq}",

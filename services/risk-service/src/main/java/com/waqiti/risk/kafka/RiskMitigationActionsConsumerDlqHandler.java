...
/**
 * DLQ Handler for RiskMitigationActionsConsumer
 *
...
@Service
@Slf4j
public class RiskMitigationActionsConsumerDlqHandler extends BaseDlqConsumer<Object> {

    public RiskMitigationActionsConsumerDlqHandler(MeterRegistry meterRegistry) {
        super(meterRegistry);
    }

    @PostConstruct
    public void init() {
        initializeMetrics("RiskMitigationActionsConsumer");
    }

    @KafkaListener(
        topics = "${kafka.topics.RiskMitigationActionsConsumer.dlq:RiskMitigationActionsConsumer.dlq}",
    ...
    protected String getServiceName() {
        return "RiskMitigationActionsConsumer";
    }
}

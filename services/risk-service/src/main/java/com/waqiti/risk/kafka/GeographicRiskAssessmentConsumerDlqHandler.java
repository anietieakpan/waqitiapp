...
/**
 * DLQ Handler for GeographicRiskAssessmentConsumer
 *
...
@Service
@Slf4j
public class GeographicRiskAssessmentConsumerDlqHandler extends BaseDlqConsumer<Object> {

    public GeographicRiskAssessmentConsumerDlqHandler(MeterRegistry meterRegistry) {
        super(meterRegistry);
    }

    @PostConstruct
    public void init() {
        initializeMetrics("GeographicRiskAssessmentConsumer");
    }

    @KafkaListener(
        topics = "${kafka.topics.GeographicRiskAssessmentConsumer.dlq:GeographicRiskAssessmentConsumer.dlq}",
    ...
    protected String getServiceName() {
        return "GeographicRiskAssessmentConsumer";
    }
}

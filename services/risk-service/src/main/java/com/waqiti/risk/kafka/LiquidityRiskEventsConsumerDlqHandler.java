...
/**
 * DLQ Handler for LiquidityRiskEventsConsumer
 *
...
@Service
@Slf4j
public class LiquidityRiskEventsConsumerDlqHandler extends BaseDlqConsumer<Object> {

    public LiquidityRiskEventsConsumerDlqHandler(MeterRegistry meterRegistry) {
        super(meterRegistry);
    }

    @PostConstruct
    public void init() {
        initializeMetrics("LiquidityRiskEventsConsumer");
    }

    @KafkaListener(
        topics = "${kafka.topics.LiquidityRiskEventsConsumer.dlq:LiquidityRiskEventsConsumer.dlq}",
    ...
    protected String getServiceName() {
        return "LiquidityRiskEventsConsumer";
    }
}

...
/**
 * DLQ Handler for AnomalyDetectionConsumer
 *
...
@Service
@Slf4j
public class AnomalyDetectionConsumerDlqHandler extends BaseDlqConsumer<Object> {

    public AnomalyDetectionConsumerDlqHandler(MeterRegistry meterRegistry) {
        super(meterRegistry);
    }

    @PostConstruct
    public void init() {
        initializeMetrics("AnomalyDetectionConsumer");
    }

    @KafkaListener(
        topics = "${kafka.topics.AnomalyDetectionConsumer.dlq:AnomalyDetectionConsumer.dlq}",
    ...
    protected String getServiceName() {
        return "AnomalyDetectionConsumer";
    }
}

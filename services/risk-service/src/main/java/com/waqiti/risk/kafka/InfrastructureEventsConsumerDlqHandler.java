...
/**
 * DLQ Handler for InfrastructureEventsConsumer
 *
...
@Service
@Slf4j
public class InfrastructureEventsConsumerDlqHandler extends BaseDlqConsumer<Object> {

    public InfrastructureEventsConsumerDlqHandler(MeterRegistry meterRegistry) {
        super(meterRegistry);
    }

    @PostConstruct
    public void init() {
        initializeMetrics("InfrastructureEventsConsumer");
    }

    @KafkaListener(
        topics = "${kafka.topics.InfrastructureEventsConsumer.dlq:InfrastructureEventsConsumer.dlq}",
    ...
    protected String getServiceName() {
        return "InfrastructureEventsConsumer";
    }
}

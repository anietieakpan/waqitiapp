...
/**
 * DLQ Handler for RiskScoringConsumer
 *
...
@Service
@Slf4j
public class RiskScoringConsumerDlqHandler extends BaseDlqConsumer<Object> {

    public RiskScoringConsumerDlqHandler(MeterRegistry meterRegistry) {
        super(meterRegistry);
    }

    @PostConstruct
    public void init() {
        initializeMetrics("RiskScoringConsumer");
    }

    @KafkaListener(
        topics = "${kafka.topics.RiskScoringConsumer.dlq:RiskScoringConsumer.dlq}",

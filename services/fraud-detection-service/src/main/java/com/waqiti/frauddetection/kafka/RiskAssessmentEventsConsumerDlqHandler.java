...
/**
 * DLQ Handler for RiskAssessmentEventsConsumer
 *
...
@Service
@Slf4j
public class RiskAssessmentEventsConsumerDlqHandler extends BaseDlqConsumer<Object> {

    public RiskAssessmentEventsConsumerDlqHandler(MeterRegistry meterRegistry) {
        super(meterRegistry);
    }

    @PostConstruct
    public void init() {
        initializeMetrics("RiskAssessmentEventsConsumer");
    }

    @KafkaListener(
        topics = "${kafka.topics.RiskAssessmentEventsConsumer.dlq:RiskAssessmentEventsConsumer.dlq}",
    ...
    protected DlqProcessingResult handleDlqEvent(Object event, Map<String, Object> headers) {
        try {
            // FIXED: Implement risk assessment events recovery logic (duplicate handler)
            log.warn("Processing DLQ risk assessment events");
            ...
            log.error("Error handling DLQ risk assessment events", e);
    ...
    protected String getServiceName() {
        return "RiskAssessmentEventsConsumer";
    }
}

...
/**
 * DTO for recording payment routing change events in the ledger service
 * 
 * This request captures all essential routing change information needed for:
...
public class RecordRoutingChangeRequest implements Serializable {

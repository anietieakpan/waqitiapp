...
public class LoyaltyPointsConsumerDlqHandler extends BaseDlqConsumer<Object> {
    ...
    protected DlqProcessingResult handleDlqEvent(Object event, Map<String, Object> headers) {
        try {
            // FIXED: Implement loyalty points consumer recovery logic
            ...
            String operation = headers.getOrDefault("operation", "").toString();
            ...
            if (failureReason.contains("Database") || failureReason.contains("Connection")) {
                ...
                // Not enough points for operation - permanent failure
                ...
                log.error("DLQ: Validation error in loyalty points. User: {}, Operation: {}. Manual review required.",
                        userId, operation);
                ...
                // Loyalty account doesn't exist yet - retry later

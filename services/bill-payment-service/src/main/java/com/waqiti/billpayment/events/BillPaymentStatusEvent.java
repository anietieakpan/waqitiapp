...
/**
 * Bill Payment Status Event - Published when payment status changes
 *
 * Consumed by notification-service for user notifications
 * Matches the event contract in com.waqiti.common.events.billpayment.BillPaymentStatusEvent
 */
@Data
@Builder
@NoArgsConstructor

...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request to credit an account")
public class AccountCreditRequestDto {

    @NotNull(message = "Amount is required")
    @DecimalMin(value = "0.01", message = "Amount must be greater than zero")
    @Digits(integer = 15, fraction = 4, message = "Invalid amount format")
    @Schema(description = "Amount to credit", example = "100.50", required = true)
    ...
    @Schema(description = "Transaction description", example = "Payment received", required = true)
    private String description;

    @Schema(description = "Reference ID for the transaction", example = "ref-987654")
    private String referenceId;

    @Schema(description = "Source of the credit", example = "TRANSFER", 
            allowableValues = {"TRANSFER", "DEPOSIT", "REFUND", "INTEREST", "ADJUSTMENT"})
    private String creditSource = "TRANSFER";

...
/**
 * DLQ Handler for ChargebackAlertsConsumer - PRODUCTION READY
 *
 * MEDIUM PRIORITY: Handles failed regular alert notifications
 * LOW PRIORITY: Non-critical alerting, monitoring only
 *
...
public class ChargebackAlertsConsumerDlqHandler extends BaseDlqConsumer<Object> {
    ...
    protected DlqProcessingResult handleDlqEvent(Object event, Map<String, Object> headers) {
        try {
            log.info("ℹ️ LOW: Chargeback alert FAILED - Non-critical");
            ...
            DLQEntry dlqEntry = DLQEntry.builder()
                    ...
                    .eventId(extractValue(eventData, "alertId", "eventId"))
                    .sourceTopic("ChargebackAlerts")
            ...
            log.error("Failed to process chargeback alert DLQ!", e);

...
/**
 * DLQ Handler for CircuitBreakerRecommendationsConsumer - PRODUCTION READY
 *
 * LOW PRIORITY: Handles failed circuit breaker recommendations - advisory only
 *
...
@Service
@Slf4j
public class CircuitBreakerRecommendationsConsumerDlqHandler extends BaseDlqConsumer<Object> {

    private final DLQEntryRepository dlqRepository;
    private final ObjectMapper objectMapper;

    public CircuitBreakerRecommendationsConsumerDlqHandler(MeterRegistry meterRegistry,
    ...
    @PostConstruct
    public void init() {
        initializeMetrics("CircuitBreakerRecommendationsConsumer");
    }

    @KafkaListener(
        topics = "${kafka.topics.CircuitBreakerRecommendationsConsumer.dlq:CircuitBreakerRecommendationsConsumer.dlq}",
    ...
    protected DlqProcessingResult handleDlqEvent(Object event, Map<String, Object> headers) {
        try {
            log.info("ℹ️ LOW: Circuit breaker recommendations FAILED - Advisory gap");
            ...
            DLQEntry dlqEntry = DLQEntry.builder()
                    ...
                    .eventId(extractValue(eventData, "recommendationId", "eventId"))
                    .sourceTopic("CircuitBreakerRecommendations")
            ...
            log.error("Failed to process circuit breaker recommendations DLQ!", e);
    ...
    protected String getServiceName() {
        return "CircuitBreakerRecommendationsConsumer";
    }
}

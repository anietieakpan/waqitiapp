...
/**
 * DLQ Handler for CircuitBreakerEvaluationsConsumer - PRODUCTION READY
 *
 * LOW PRIORITY: Handles failed circuit breaker evaluations - monitoring only
 *
...
@Service
@Slf4j
public class CircuitBreakerEvaluationsConsumerDlqHandler extends BaseDlqConsumer<Object> {

    private final DLQEntryRepository dlqRepository;
    private final ObjectMapper objectMapper;

    public CircuitBreakerEvaluationsConsumerDlqHandler(MeterRegistry meterRegistry,
    ...
    @PostConstruct
    public void init() {
        initializeMetrics("CircuitBreakerEvaluationsConsumer");
    }

    @KafkaListener(
        topics = "${kafka.topics.CircuitBreakerEvaluationsConsumer.dlq:CircuitBreakerEvaluationsConsumer.dlq}",
    ...
    protected DlqProcessingResult handleDlqEvent(Object event, Map<String, Object> headers) {
        try {
            log.info("ℹ️ LOW: Circuit breaker evaluations FAILED - Monitoring gap");
            ...
            DLQEntry dlqEntry = DLQEntry.builder()
                    ...
                    .eventId(extractValue(eventData, "evaluationId", "eventId"))
                    .sourceTopic("CircuitBreakerEvaluations")
            ...
            log.error("Failed to process circuit breaker evaluations DLQ!", e);
    ...
    protected String getServiceName() {
        return "CircuitBreakerEvaluationsConsumer";
    }
}

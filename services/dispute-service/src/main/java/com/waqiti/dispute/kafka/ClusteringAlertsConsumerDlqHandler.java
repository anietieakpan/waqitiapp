...
/**
 * DLQ Handler for ClusteringAlertsConsumer - PRODUCTION READY
 *
 * LOW PRIORITY: Handles failed clustering alerts - pattern detection only
 *
...
@Service
@Slf4j
public class ClusteringAlertsConsumerDlqHandler extends BaseDlqConsumer<Object> {

    private final DLQEntryRepository dlqRepository;
    private final ObjectMapper objectMapper;

    public ClusteringAlertsConsumerDlqHandler(MeterRegistry meterRegistry,
    ...
    @PostConstruct
    public void init() {
        initializeMetrics("ClusteringAlertsConsumer");
    }

    @KafkaListener(
        topics = "${kafka.topics.ClusteringAlertsConsumer.dlq:ClusteringAlertsConsumer.dlq}",
    ...
    protected DlqProcessingResult handleDlqEvent(Object event, Map<String, Object> headers) {
        try {
            log.info("ℹ️ LOW: Clustering alerts FAILED - Pattern detection gap");
            ...
            DLQEntry dlqEntry = DLQEntry.builder()
                    ...
                    .eventId(extractValue(eventData, "clusterId", "eventId"))
                    .sourceTopic("ClusteringAlerts")
            ...
            log.error("Failed to process clustering alerts DLQ!", e);
    ...
    protected String getServiceName() {
        return "ClusteringAlertsConsumer";
    }
}

...
import NatureIcon from '@mui/icons-material/EmojiNature';
import FoodIcon from '@mui/icons-material/EmojiFoodBeverage';
import TravelIcon from '@mui/icons-material/EmojiTransportation';
import ObjectsIcon from '@mui/icons-material/EmojiObjects';
import SymbolsIcon from '@mui/icons-material/EmojiSymbols';
...
const EmojiPicker: React.FC<EmojiPickerProps> = ({
  ...
  const filteredEmojis = searchQuery
    ? categories.flatMap(cat => cat.emojis).filter(emoji =>
